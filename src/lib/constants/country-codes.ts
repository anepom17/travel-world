 ...
 * Required because world-atlas TopoJSON uses numeric codes,
 * while our DB stores alpha-2 codes.
 */
...
/** Reverse mapping: alpha-2 → numeric (for rendering visited countries on the map) */
